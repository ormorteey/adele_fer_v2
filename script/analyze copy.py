...
# In[ ]:
    ...
    if categorical:
        data_df_cat = make_cat_dataset(df=data_df, cols = pred_cols, bins=num_combine, save=save, save_path=filepath)
        print("\n===========================================================\n")
...
# In[ ]:
    ...
    response_filter_str = '_'.join(valid_response_list) if filter_response is not None else 'all_response_subtypes'
...
# In[ ]:
    ...
    if combine:
        ...
        if categorical:
            save_dir = os.path.join(args.save_dir, '1_feature_cat')
        else:
            save_dir = os.path.join(args.save_dir, '1_feature_raw')
